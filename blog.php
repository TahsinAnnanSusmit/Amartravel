...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
					...
					<div class="col-md-8">
						<div class="wrap-division">
							<article class="animate-box">
								<div class="blog-img" style="background-image: url(images/pic5.jpg);"></div>
								<div class="desc">
									<div class="meta">
										<p>
							...
							<article class="animate-box">
								<div class="blog-img" style="background-image: url(images/pic7.jpg);"></div>
								<div class="desc">
									<div class="meta">
										<p>
											<span>Feb 24, 2018 </span>
							...
							<article class="animate-box">
								<div class="blog-img" style="background-image: url(images/pic8.jpg);"></div>
								<div class="desc">
									<div class="meta">
										<p>
											<span>Feb 24, 2018 </span>
							...
							<div class="side animate-box">
								...
								<div class="blog-entry-side">
									<a href="blog.html" class="blog-post">
										<span class="img" style="background-image: url(images/pic1.jpg);"></span>
										<div class="desc">
								...
								<div class="blog-entry-side">
									<a href="blog.html" class="blog-post">
										<span class="img" style="background-image: url(images/pic2.jpeg);"></span>
										<div class="desc">
											<span class="date">Feb 24, 2018</span>
								...
								<div class="blog-entry-side">
									<a href="blog.html" class="blog-post">
										<span class="img" style="background-image: url(images/pic5.jpg);"></span>
										<div class="desc">
											<span class="date">Feb 24, 2018</span>
											<h3>Our Secret Island Boat Tour Is just for You</h3>
		...
		<div id="colorlib-subscribe" style="background-image: url(images/pic3.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
