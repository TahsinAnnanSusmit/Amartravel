	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/pic1.jpg);">
			   	...
			   	<li style="background-image: url(images/pic2.jpeg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>7 Days Cruises</h2>
				   					<h1>From Bandarban to Cox's Bazar</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			   	...
			   	<li style="background-image: url(images/pic3.jpg);">
			   		...
			   		<div class="container-fluids">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>Explore All the Beauty of</h2>
				   					<h1>BANGLADESH</h1>
				   				</div>
				   			</div>
				   		</div>
			   	...
			   	<li style="background-image: url(images/pic4.jpeg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
			...
			<div class="container">
				<div class="row row-pb-md">
					...
					<div class="col-md-2 colorlib-widget">
						...
						<p>
							<ul class="colorlib-footer-links">
								<li><a href="#">Satemon Beach Resort</a></li>
								<li><a href="#">Hotel Sea Crown</a></li>
								<li><a href="#">SKD Resort</a></li>
								<li><a href="#">Coral view Resort</a></li>
								<li><a href="#">Sajek Eco Resort</a></li>
							</ul>
						</p>
					</div>
					<div class="col-md-2">
